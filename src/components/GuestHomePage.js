            ...
            renderItem={(item) => (
              <List.Item>
                <Card
                  ...
                  extra={<BookStayButton stay={item} goToReservation={this.props.goToReservation}/>}
                >
                  {
                    <Carousel
                      dots={false}
...
class GuestHomePage extends React.Component {
    ...
    render() {
        return (
        <Tabs activeKey={this.state.activetab} onChange={this.handleChange} destroyInactiveTabPane={true}>
            <TabPane tab="Search Stays" key="1">
            <SearchStays goToReservation={this.goToReservation} />
            </TabPane>
            <TabPane tab="My Reservations" key="2">
            <MyReservations />
            </TabPane>
